...
#define BSDIFF_MAGIC			"ANUI"

/****************************flash configure****************************/
#define F_SECTORE_SIZE			0x8000		
#define F_SECTOR_MASK			0xFFFF8000	
#define F_ALIGN_SECTOR(addr)	((addr)&F_SECTOR_MASK)

#define F_MAX_FW_SIZE			0x5F8000 					
#define F_BACKUP_SIZE			BL_FLASH_OTA_BACKUP_SIZE	
#define F_FOR_STATUS_SIZE		F_SECTORE_SIZE				
#define F_DOWN_SIZE				BL_FLASH_OTA_UPDATE_SIZE	
